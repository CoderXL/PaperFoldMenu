...
#define COLOR_WITH_HEX(rgbValue,a) COLOR_WITH_RGB(\
(float)((rgbValue & 0xFF0000) >> 16),(float)((rgbValue & 0xFF00) >> 8),(float)(rgbValue & 0xFF),a)

#define kNavToolBarHeight 44

#define ViewControllerBackGroudColor [UIColor whiteColor]
#define kThemeTextColor              COLOR_WITH_HEX(0xf9cecd, 1.0)
#define kThemeTextHighLightColor     COLOR_WITH_HEX(0xffafad, 1.0)
